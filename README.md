...
The library currently does currently not support all measuring modes. In the table below, "semi-complete" means that it will give you the correct values if you already have the mode selected on the meter.  "Complete" means it will also detect whether or not you are in the given mode.
